...
public class ChattingRoom {
    ...
    public static ChattingRoom createChattingroom(int numPerson,String chatroom_name, List<UserChattingRoom> userChattingRooms) {
        //ChattingRoom 객체만들어 속성 set하고 받은 userChattingRooms와 양방향으로 연관관계 설정(서로를 멤버로 설정)
        ChattingRoom chattingRoom = new ChattingRoom();
        chattingRoom.setChattingRoomName(chatroom_name);
