        ...
        >
          ...
          <div className="modal-content">
            ...
            <div className="appointment-info">
              <div>
                ...
                <Space direction="vertical" size={12}>
                  <DatePicker defaultValue={dayjs('0000/00/00', dateFormat)} format={dateFormat} />
            ...
            <div className="button-group">
                <Button type="primary" className="appointment-button" onClick={handleAppointment}>약속잡기</Button>
                <Button type="primary" className="invite-button" onClick={handleShowFriends}>친구초대</Button>
            </div>
